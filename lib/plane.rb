...
class Plane
  ...
  def land(airport)
    ...
    raise "#{self} cannot land, the weather is stormy" if airport.check_weather == "Stormy"
  ...
  def take_off(airport)
    ...
    raise "#{self} cannot take off, the weather is stormy" if airport.check_weather == "Stormy"
