...
class Plane
  ...
  def take_off_from(airport)
    raise "Plane not in airport hangar. Cannot take off!" unless airport.holding?(self)
  ...
  def land_at(airport)
    raise "Plane already in airport hangar. Cannot land plane!" if airport.holding?(self)
