...
```
>> I removed the functionality for planes to be removed from the airport, so this is missing currently. 

>> I did not get time to remove the following edge cases:
