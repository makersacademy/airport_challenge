...
1) Translated user stories into domain models and then feature tests (./docs/feature_tests.md)

2) Proceeded following the loop feature test - unit test - code story by story.
