...
* User stories as above have been implemented.
...
* Planes cannot land if an airport is full. The default capacity of the airport is set to 20, but this can be changed on initialization of the class instance or upon calling the capacity method using the attr_accessor
