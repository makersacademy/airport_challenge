...
Approach
-------
This software program shows the interaction among three classes: Airport, Plane, and Weather. Airport is the main platform and can control air traffic by allowing a specific plane to take off or land. Plane has little functionality and is controlled by Airport. Weather is a factor that influences Airport's decision.   
