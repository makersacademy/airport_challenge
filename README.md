...
Heather's 01 weekend challenge

Approach
---------
* Mapped out objects and messages for each story.
* Created separate class and spec file for each of the objects.
* Used pry to initially work out what I wanted to test for in each story.
* Added unit tests and tried to pass each test with accompanying code.
