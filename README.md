...
Plane status (Passed)
Plane landing (Passed)
Plane takeoff (Passed)
Storms prevent landing (Passed)
Storms prevent takeoff (Passed)
Full airport cannot land planes (Passed)
Variable and default capacity (Passed)
Errors raised for inconsistent actions (Passed)
