...
The Plane - initially is flying (our var which describes plane -  flying = true) . Plane also  may be flying, 2) landing, 3) taking off, 4) on the ground. it’s important that plane should be in the sky in the first 3 conditions (our condition  flying = true), when the plane is on the ground (our condition flying = false). 
...
The Airport 1) should have capacity . The airport must deny to plane landing 2) if it’s capacity  is overweighted or 3) the weather is bad. The airport must deny to plane taking off if there isn’t any plane or the wether is bad.  
The weather may be good or may be bad (stormy)   
