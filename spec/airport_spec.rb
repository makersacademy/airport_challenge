  ...
  describe 'traffic control' do
    context 'when airport is full' do
      it 'does not allow a plane to land' do
        ...
        expect { subject.plane_land(Plane.new)}.to raise_error 'Cannot currently land at airport'
      end
    end
    ...
    context 'when airport is empty' do
      it 'no planes can take off' do
        ...
        expect { subject.plane_take_off(plane)}.to raise_error 'Cannot currently take off'
      end
    end
    ...
    context 'when weather conditions are stormy' do
      ...
      it 'does not allow a plane to land' do
        ...
        expect { subject.plane_land(plane) }.to raise_error 'Cannot currently land at airport'
      end
