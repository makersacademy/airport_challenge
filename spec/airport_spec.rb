...
describe Airport do
  # let setup to test the same plane object in 'some' unit tests
  let(:airplane) { Plane.new }

  # Unit test to check correct instantiation of Airport object
  it 'when instantiated it creates an instance of Airport class' do
    expect(subject).to be_an_instance_of(Airport)
  end

  # Unit test to check instantiation of Airport object initializes with an empty array
  ...
  # Unit test to check if airport object responds to #land method call
  it 'responds to #land method call' do
    expect(subject).to respond_to(:land).with(1).arguments
  end

  # Unit test to check a plane lands at the airport
  ...
  # Unit test to check if airport object responds to #take_off method call
  it 'responds to #land method call' do
    expect(subject).to respond_to(:take_off).with(1).arguments
  end

  # Unit test to check a plane takes off at the airport
