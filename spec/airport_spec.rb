...
describe Airport do
  ...
  describe '#land' do
    ...
    it 'prevents a plane from landing in the event of bad weather' do
      ...
      expect { airport.land(plane) }.to raise_error(StandardError, "Plane is unable to land due to weather conditions")
    end
  end
  ...
  describe '#take_off' do
    ...
    it 'prevents take off in the event of bad weather' do
      ...
      expect { airport.take_off(plane) }.to raise_error(StandardError, "Plane is unable to take off due to weather conditions")
    end
  end
end
