...
describe AirTrafficControl do
  ...
  let(:airport1) { double :airport1, id:111, status_code: :JFK}
  let(:airport2) { double :airport1, id:222, status_code: :LHR}
  ...
  describe '#add_airport' do
    it 'puts airports under the management of Air Traffic Control' do
      ...
      expect(subject.status_codes).to include(airport1.status_code)
    end
  end
