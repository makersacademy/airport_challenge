...
describe Airport do
  ...
  describe '#land' do
    ...
    it "prevents plane from landing if it has already landed" do
      plane = Plane.new
      subject.land(plane)
  ...
  describe '#take_off' do
    ...
    it 'raises error if hangar is empty' do
      expect {subject.take_off(nil)}.to raise_error "hangar is empty"
    end
    ...
    it 'prevents plane from taking off if its already flying' do
      plane = Plane.new
    ...
    #expect {another_airport.take_off(plane)}.to raise_error "plane is not at this airport"   #need to put plane as parameter for take_off method
