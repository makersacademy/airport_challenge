...
describe Plane do
  ...
  it "checks the weather report" do
    ...
    expect(subject.safe_to_land?(weather_report.weather_conditions)).to eq("stormy")
    expect{subject.landed?}.to raise_error "Unable to land due to stormy conditions"
  end
