...
describe Plane do
  ...
  it 'will raise an error if a plane tries to land when it is already landed' do
    boeing.state = "Landed"
    heathrow = double("airport", :hangar => [boeing], :capacity => 60, :weather => "Sunny")
  ...
  it 'will raise an error if a plane tries to take off that is not currently in the airport' do
    boeing.state = "Landed"
    heathrow = double("airport", :hangar => [], :capacity => 60, :weather => "Sunny")
    manchester = double("airport", :hangar => [boeing], :capacity => 29, :weather => "Sunny")
  ...
  it 'will stop the plane landing if the weather is stormy' do
    heathrow = double("airport", :hangar => [], :capacity => 60, :weather => "Stormy")
  ...
  it 'will stop the plane from taking off if the weather is stormy' do
    boeing.state = "Landed"
    heathrow = double("airport", :hangar => [boeing], :capacity => 60, :weather => "Stormy")
